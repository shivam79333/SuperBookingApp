  ...
  return (
    <nav className="pt-6 pb-6 px-8 border-b border-gray-100">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-8">
        <Link to="/" className="flex gap-2" aria-label="Go to home">
          <div className="logo-icon w-15 h-15 flex-shrink-0 block">
            <svg
        ...
        <div className="flex-1 max-w-xl relative">
          <div className="rounded-full bg-gradient-to-r from-[var(--md-sys-color-primary-bright-src)] to-[var(--md-sys-color-primary)] p-[3px]">
            <div className="rounded-[calc(theme(borderRadius.lg)-2px)] bg-white rounded-full">
              <input
